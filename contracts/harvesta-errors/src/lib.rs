...
pub enum HarvestaError {
    ...
    // ── NFT certificate (120–123) ───────────────────────────────────────────────
    TokenAlreadyMinted = 120,
    InvalidPlantingDate = 121,
    TokenNotFound = 122,
    NotTokenOwner = 123,

    // ── Verifier staking (124–127) ──────────────────────────────────────────────
    MinStakeMustBePositive = 124,
    VerifierNotStaked = 125,
    SlashExceedsStake = 126,
    InsufficientStake = 127,

    // ── Carbon credit marketplace (128–134) ───────────────────────────────────
    ListingAmountMustBePositive = 128,
    PriceMustBePositive = 129,
    ListingNotFound = 130,
    ListingNotActive = 131,
    BuyAmountMustBePositive = 132,
    InsufficientLiquidity = 133,
    SelfTrade = 134,
}
